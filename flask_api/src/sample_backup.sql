...
CREATE TABLE IF NOT EXISTS `crew` (
  ...
  `crew_name` int(11) NOT NULL COMMENT '클랜 이름',
...
INSERT INTO `crew` (`crew_id`, `crew_name`, `crew_desc`, `crew_boundary`, `crew_exist`) VALUES
	(1, 0, 1, 33.3, 1),
	(3, 22223, 32, 222, 1);
...
CREATE TABLE IF NOT EXISTS `items` (
  ...
  `item_nomo` int(11) NOT NULL COMMENT 'nomo de aĵo',
  `item_klarigo` int(11) NOT NULL COMMENT 'klarigo de aĵo',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='차단상대';
